...
![mockup página autenticación](public/img/mockup_auth.png)
#### Página inicio 
...
![mockup página inicio](public/img/mockup_home.png)
...
![mockup página editar tarea](public/img/mockup_edit.png)
#### Página estadísticas 
...
![mockup página estadísticas](public/img/mockup_statistics.png)
#### Página categorías
Se crean las categorías y hay una tabla, con las categorías donde se pueden ver, editar y borrar  
![mockup página categorías](public/img/mockup_categories.png)
